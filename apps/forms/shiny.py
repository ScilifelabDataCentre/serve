...
class ShinyForm(AppBaseForm):
    ...
    proxy = forms.BooleanField(required=False, 
                               ...
                               help_text="<i class='bi bi-question-circle me-2'></i> Check this box if your app requires lots of compute power. This will enable a proxy to handle the load.")
    ...
    class Meta:
        model = ShinyInstance
        fields = ["name","description", "proxy", "volume", "flavor", "access", "source_code_url", "port", "image", "tags"]