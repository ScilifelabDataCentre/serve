from crispy_forms.layout import Layout, Div, Button, Submit, HTML, Field
...
class FilemanagerForm(AppBaseForm):
    ...
    def _setup_form_helper(self):
        ...
        body = Div(
            Div(
                HTML("<p>You are about to activate file manager on SciLifeLab Serve. You can use it to upload or download files to a volume associated with this project. This service will be active for 24 hours and automatically terminated afterwards. The uploaded files will stay on the volume even after this service has been terminated.</p>"),
