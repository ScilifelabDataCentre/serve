...
class FlavorForm(forms.Form):
    cpu_req = forms.CharField(label="CPU requests", max_length=10, initial="200m")
    mem_req = forms.CharField(label="Memory requests", max_length=15, initial="0.5Gi")
    ephmem_req = forms.CharField(label="Ephemeral storage requests", max_length=15, initial="200Mi")

    cpu_lim = forms.CharField(label="CPU limits", max_length=10, initial="2000m")
    mem_lim = forms.CharField(label="Memory limits", max_length=15, initial="4Gi")
    ephmem_req = forms.CharField(label="Ephemeral storage limits", max_length=15, initial="1000Mi")
