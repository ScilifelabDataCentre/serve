...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for project in projects_to_delete:
            ...
            self.stdout.write(self.style.SUCCESS(f"Successfully deleted project {project.name}"))

        self.stdout.write(self.style.SUCCESS(f"Successfully deleted {projects_to_delete.count()} projects"))
