...
def collect_vocabulary_keywords(sources_filter=None, vocab_dir=None):
    ...
    all_sources = {
        ...
        'euroscivoc': {
            'url': 'https://op.europa.eu/o/opportal-service/euvoc-download-handler?cellarURI=http%3A%2F%2Fpublications.europa.eu%2Fresource%2Fdistribution%2Feuroscivoc%2F20250924-0%2Frdf%2Fskos_xl%2FEuroSciVoc.rdf&fileName=EuroSciVoc.rdf',
...
def parse_gemet_rdf_gz(config):
    ...
    try:
        ...
        search_terms = ['a', 'e', 'i', 'o', 'u', 'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z']
...
def store_keywords_as_binary(source: str, keywords: list, config: dict, vocab_dir: str = None) -> int:
