...
def test_transform_example_schema_org():
        ...
        "hasPart": [
            {
                ...
                "additionalProperty": [
                    ...
                    {"name": "cpuLimit", "value": "2000m"}
                ],
                "hasPart": {
                    "@type": "SoftwareSourceCode",
                    "codeRepository": "https://source.org"
                }
            }
        ],
        "about": {
    ...
    # Verify description
    assert result["metadata"]["description"] == "Structured metadata for applications, users, and projects deployed on the SciLifeLab Serve platform."
