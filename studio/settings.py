...
CELERY_RESULT_BACKEND = "redis://:%s@%s:%d/%d" % (REDIS_PASSWORD, REDIS_HOST, REDIS_PORT, REDIS_DB)
...
CACHES = {
    "default": {
        ...
        "LOCATION": f"redis://:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB}",  # https://redis.io/docs/latest/commands/select/
        "KEY_PREFIX": "serve",
