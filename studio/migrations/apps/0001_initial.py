        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "appinstance",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="resourcedata", to="apps.appinstance"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "appinstance",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="status", to="apps.appinstance"
                    ),
                ),
            ],
            options={
